...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/aVAER200/Files_Modedev/main/File_Bot/commands.lua") 
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس', url="t.me/tft4t"},
},
{
...
------------------------------------------------------------------------------------------------------------
if text == 'مبرمج السورس' or text == 'فواز مطور السورس' or text == 'فخر العرب فوازي' or text == 'مطور السورس' then
local Text =[[
...
{
{text = 'مطور السـورس', url="t.me/WTTTW"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/aVAER200/Files_Modedev/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/aVAER200/Files_Modedev/main/File_Bot/"..file)
if res == 200 then
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝚁𝙴𝚅𝙾𝚁 - SoUrCe](https://t.me/tft4t)
]]
